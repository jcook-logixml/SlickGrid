  ...
  function SlickGrid(container, data, columns, options) {
    ...
    function init() {
      ...
      for (var i = 0; i < columns.length; i++) {
        ...
        // if (!m.visible) { continue; } // allow this setting of property for the moment
        columnsById[m.id] = i;
    ...
    function measureScrollbar() {
      var $c = templating.createElement("measureScrollbar").appendTo("body");
      var dim = {
    ...
    function getMaxSupportedCssHeight() {
      ...
      var div = templating.createElement("getMaxSupportedCssHeight").appendTo(document.body);
    ...
    function autosizeColumns() {
      ...
      while (total > availWidth && shrinkLeeway) {
        ...
        for (i = 0; i < columns.length && total > availWidth; i++) {
          c = columns[i];
          var width = widths[i];
          if (!c.visible || !c.resizable || width <= c.minWidth || width <= absoluteColumnMinWidth) {
            continue;
          }
      ...
      while (total < availWidth) {
        ...
        for (i = 0; i < columns.length && total < availWidth; i++) {
          c = columns[i];
          if (!c.visible || !c.resizable || c.maxWidth <= c.width) {
            continue;
          }
      ...
      for (i = 0; i < columns.length; i++) {
        ...
        if (c.rerenderOnResize && c.width != widths[i]) {
          reRender = true;
        }
        c.width = widths[i];
      }
    ...
    function appendRowHtml(stringArray, row, range) {
      ...
      stringArray.push(templating.createMarkup("row-end"));
    }
    ...
    function appendCellHtml(stringArray, row, cell, colspan) {
      ...
      stringArray.push(templating.createMarkup("cell-end"));
    ...
    function getCellNodeBox(row, cell) {
      ...
      for (var i = 0; i < cell; i++) {
        x1 += columns[i].width || 0;
      }
      var x2 = x1 + columns[cell].width || 0;
